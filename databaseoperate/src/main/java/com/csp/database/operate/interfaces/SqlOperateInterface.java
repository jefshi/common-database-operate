...
public interface SqlOperateInterface<T extends TableBeanInterface> {
    ...
    /**
     * {@link com.csp.database.operate.bean.TableField#tableName}
     */
    String getTableName();

    /**
     * {@link com.csp.database.operate.bean.TableField#fields}
     */
    String[] getFields();

    /**
     * {@link com.csp.database.operate.bean.TableField#fieldsType}
     */
    String[] getFieldsType();

    /**
     * {@link com.csp.database.operate.bean.TableField#pkFields}
     */
    String[] getPkFields();
