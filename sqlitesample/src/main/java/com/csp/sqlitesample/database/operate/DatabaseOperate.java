...
public class DatabaseOperate {
    ...
    public static void openDatabase(Context context) {
        SqliteSampleHelper.getInstance(context).openDatabase(null);
    }

    public static void closeDatabase(Context context) {
        SqliteSampleHelper.getInstance(context).closeDatabase();
    }

    public static void beginTransaction(Context context) {
        SqliteSampleHelper.getInstance(context).beginTransaction();
    }

    public static void endTransaction(Context context) {
        SqliteSampleHelper.getInstance(context).endTransaction();
    }

    public static void setTransactionSuccessful(Context context) {
        SqliteSampleHelper.getInstance(context).setTransactionSuccessful();
    }
    ...
    public static boolean resetDatabase(Context context) {
        SQLiteHelper helper = SqliteSampleHelper.getInstance(context);
